...
import app.rutherford.database.jooq.generated.keys.AUTH_USER_TOKEN__AUTH_USER_TOKEN_USER_ID_FKEY
...
open class AuthUserToken(
     ...
     */
    val STATE: TableField<AuthUserTokenRecord, String?> = createField(DSL.name("state"), SQLDataType.VARCHAR(32).nullable(false), this, "")
