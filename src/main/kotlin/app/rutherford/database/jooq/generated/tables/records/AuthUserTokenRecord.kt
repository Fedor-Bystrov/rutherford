...
open class AuthUserTokenRecord() : UpdatableRecordImpl<AuthUserTokenRecord>(AuthUserToken.AUTH_USER_TOKEN), Record7<UUID?, Instant?, Instant?, Instant?, String?, String?, UUID?> {
    ...
    override fun field5(): Field<String?> = AuthUserToken.AUTH_USER_TOKEN.STATE
    ...
    override fun value5(value: String?): AuthUserTokenRecord {
        this.state = value
        return this
    }
    ...
    override fun values(value1: UUID?, value2: Instant?, value3: Instant?, value4: Instant?, value5: String?, value6: String?, value7: UUID?): AuthUserTokenRecord {
        this.value1(value1)
        this.value2(value2)
        this.value3(value3)
        this.value4(value4)
