...
open class AuthUser(
     ...
     */
    val CREATED_AT: TableField<AuthUserRecord, Instant?> = createField(DSL.name("created_at"), SQLDataType.TIMESTAMP(6).nullable(false), this, "", InstantConverter())

    /**
     * The column <code>public.auth_user.updated_at</code>.
     */
    val UPDATED_AT: TableField<AuthUserRecord, Instant?> = createField(DSL.name("updated_at"), SQLDataType.TIMESTAMP(6).nullable(false), this, "", InstantConverter())
     ...
     */
    val APPLICATION_NAME: TableField<AuthUserRecord, ApplicationName?> = createField(DSL.name("application_name"), SQLDataType.VARCHAR(64).nullable(false), this, "", EnumConverter<String, ApplicationName>(String::class.java, ApplicationName::class.java))
